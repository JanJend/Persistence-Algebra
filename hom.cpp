...
void compute_hom_space(std::filesystem::path input_path_A, std::filesystem::path input_path_B, int type,  bool info = false) {
...
int main(int argc, char** argv) {
    ...
    if (argc < 3) {
        ...
        if(false){
            filepath_A = "/home/wsljan/MP-Workspace/data/hypoxic_regions/hypoxic_FoxP3_dim1_100x100.scc";
    ...
    compute_hom_space(input_path_A, input_path_B, type, info);
